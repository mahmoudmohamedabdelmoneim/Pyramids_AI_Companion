...
[Activity(Label = "@string/king_khufu_station_title")]
public sealed class KingKhufuStationActivity : Activity
{
    private readonly LocalTourVoiceService _voiceService = LocalTourVoiceService.Shared;
    private readonly OnDeviceTourGuideService _chatService = new(TourGuideStop.KhufuStation);
    ...
    protected override void OnCreate(Bundle? savedInstanceState)
    {
        ...
        var guide = GetString(Resource.String.king_khufu_station_message);

        FindViewById<TextView>(Resource.Id.sphinx_station_eyebrow_text)!
            .SetText(Resource.String.king_khufu_station_eyebrow);
        FindViewById<TextView>(Resource.Id.sphinx_station_title_text)!
            .SetText(Resource.String.king_khufu_station_title);
        ...
        {
            _voiceService.Stop();
            StartActivity(new Android.Content.Intent(this, typeof(KingKhufuHistoryActivity)));
        };
        ...
        _conversation!.SetText(Resource.String.king_khufu_station_chat_welcome);
