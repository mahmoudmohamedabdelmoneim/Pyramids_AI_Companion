...
[Activity(Label = "@string/sphinx_station_title")]
public sealed class SphinxStationActivity : Activity
{
    private readonly LocalTourVoiceService _voiceService = LocalTourVoiceService.Shared;
    private readonly OnDeviceTourGuideService _chatService = new(TourGuideStop.SphinxStation);
    ...
    protected override void OnCreate(Bundle? savedInstanceState)
    {
        ...
        var guide = GetString(Resource.String.sphinx_station_message);
        ...
        {
            _voiceService.Stop();
            StartActivity(new Android.Content.Intent(this, typeof(GreatSphinxActivity)));
        };
