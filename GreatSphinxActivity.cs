...
[Activity(Label = "@string/great_sphinx_title")]
public sealed class GreatSphinxActivity : Activity
{
    private readonly LocalTourVoiceService _voiceService = LocalTourVoiceService.Shared;
    private readonly OnDeviceTourGuideService _chatService = new(TourGuideStop.GreatSphinx);
    ...
    protected override void OnCreate(Bundle? savedInstanceState)
    {
        ...
        var guide = GetString(Resource.String.great_sphinx_message);
        FindViewById<TextView>(Resource.Id.sphinx_station_eyebrow_text)!
            .SetText(Resource.String.great_sphinx_eyebrow);
        FindViewById<TextView>(Resource.Id.sphinx_station_title_text)!
            .SetText(Resource.String.great_sphinx_title);
        ...
        {
            _voiceService.Stop();
            var destination = HasAccessPassTicket() || HasPriorityPassTicket()
                ? typeof(KingKhufuTransferActivity)
        ...
        _conversation!.SetText(Resource.String.great_sphinx_chat_welcome);
