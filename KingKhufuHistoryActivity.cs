...
[Activity(Label = "@string/king_khufu_history_title")]
public sealed class KingKhufuHistoryActivity : Activity
{
    private readonly LocalTourVoiceService _voiceService = LocalTourVoiceService.Shared;
    private readonly OnDeviceTourGuideService _chatService = new(TourGuideStop.KhufuHistory);
    ...
    protected override void OnCreate(Bundle? savedInstanceState)
    {
        ...
        var guide = GetString(Resource.String.king_khufu_history_message);

        FindViewById<TextView>(Resource.Id.sphinx_station_eyebrow_text)!
            .SetText(Resource.String.king_khufu_history_eyebrow);
        FindViewById<TextView>(Resource.Id.sphinx_station_title_text)!
            .SetText(Resource.String.king_khufu_history_title);
        ...
        {
            _voiceService.Stop();
            StartActivity(new Android.Content.Intent(this, typeof(MeresankhTombActivity)));
        };
        ...
        _conversation!.SetText(Resource.String.king_khufu_history_chat_welcome);
