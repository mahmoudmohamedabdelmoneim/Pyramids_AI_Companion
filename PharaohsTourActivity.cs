...
{
    [Activity(Label = "@string/pharaohs_tour_title")]
    public class PharaohsTourActivity : Activity
    {
        protected override void OnCreate(Bundle? savedInstanceState)
        {
            base.OnCreate(savedInstanceState);
            SetContentView(Resource.Layout.activity_pharaohs_tour);
            ...
            cartButton.Click += (_, _) =>
                CartActions.AddAndOpenCart(this,
                    new CartSelection("Pharaoh's Tour ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â Foreigners (USD 250)", "Gate 6", foreignersTickets),
                    new CartSelection("Pharaoh's Tour ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â Egyptians (USD 200)", "Gate 6", egyptiansTickets));
