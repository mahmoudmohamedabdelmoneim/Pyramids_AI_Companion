...
public sealed class SphinxJourneyActivity : Activity
{
    ...
    private readonly OnDeviceTourGuideService _chatService = new(TourGuideStop.SphinxJourney);
    ...
    protected override void OnCreate(Bundle? savedInstanceState)
    {
        ...
        _guide = GetString(Resource.String.sphinx_journey_message);
        ...
        FindViewById<TextView>(Resource.Id.sphinx_transfer_eyebrow_text)!
            .SetText(Resource.String.sphinx_journey_eyebrow);
        ...
        FindViewById<TextView>(Resource.Id.sphinx_transfer_expand_map_button)!.Click += (_, _) =>
            OpenFullScreenMap();
        ...
        {
            _voiceService.Stop();
            StartActivity(new Android.Content.Intent(this, typeof(SphinxStationActivity)));
        };
        ...
        _conversation!.SetText(Resource.String.sphinx_journey_chat_welcome);
