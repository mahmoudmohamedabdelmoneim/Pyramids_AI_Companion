...
[Activity(Label = "@string/khafre_surroundings_title")]
public sealed class KhafreSurroundingsActivity : Activity
{
    private readonly LocalTourVoiceService _voiceService = LocalTourVoiceService.Shared;
    private readonly OnDeviceTourGuideService _chatService = new(TourGuideStop.KhafreSurroundings);
    ...
    protected override void OnCreate(Bundle? savedInstanceState)
    {
        ...
        var guide = GetString(Resource.String.khafre_surroundings_message);
        ...
        {
            _voiceService.Stop();
            StartActivity(new Android.Content.Intent(this, typeof(KhafreCemeteryActivity)));
        };
