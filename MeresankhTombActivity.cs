...
[Activity(Label = "@string/meresankh_tomb_title")]
public sealed class MeresankhTombActivity : Activity
{
    private readonly LocalTourVoiceService _voiceService = LocalTourVoiceService.Shared;
    private readonly OnDeviceTourGuideService _chatService = new(TourGuideStop.MeresankhTomb);
    ...
    protected override void OnCreate(Bundle? savedInstanceState)
    {
        ...
        var guide = GetString(Resource.String.meresankh_tomb_message);

        FindViewById<TextView>(Resource.Id.sphinx_station_eyebrow_text)!
            .SetText(Resource.String.meresankh_tomb_eyebrow);
        FindViewById<TextView>(Resource.Id.sphinx_station_title_text)!
            .SetText(Resource.String.meresankh_tomb_title);
        ...
        {
            _voiceService.Stop();
            StartActivity(new Android.Content.Intent(this, typeof(KhufuCemeteriesActivity)));
        };
        ...
        _conversation!.SetText(Resource.String.meresankh_tomb_chat_welcome);
