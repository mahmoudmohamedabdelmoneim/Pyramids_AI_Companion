...
static void release_session_resources() {
...
Java_com_companyname_AndroidApp1_LocalQwenBridge_init(JNIEnv *env, jobject /*unused*/, jstring nativeLibDir) {
...
Java_com_companyname_AndroidApp1_LocalQwenBridge_load(JNIEnv *env, jobject, jstring jmodel_path) {
    // The JNI bridge is process-wide. Always release a previous model before replacing it,
    // including a partially prepared model from a failed initialization attempt.
...
extern "C"
JNIEXPORT jint JNICALL
Java_com_companyname_AndroidApp1_LocalQwenBridge_prepare(JNIEnv * /*env*/, jobject /*unused*/) {
    if (g_model == nullptr) {
        return 1;
    }
...
Java_com_companyname_AndroidApp1_LocalQwenBridge_systemInfo(JNIEnv *env, jobject /*unused*/) {
    return env->NewStringUTF(llama_print_system_info());
}

extern "C"
JNIEXPORT jstring JNICALL
Java_com_companyname_AndroidApp1_LocalQwenBridge_benchModel(JNIEnv *env, jobject /*unused*/, jint pp, jint tg,
                                                      jint pl, jint nr) {
...
extern "C"
JNIEXPORT jint JNICALL
Java_com_companyname_AndroidApp1_LocalQwenBridge_processSystemPrompt(
        JNIEnv *env,
        jobject /*unused*/,
...
extern "C"
JNIEXPORT jint JNICALL
Java_com_companyname_AndroidApp1_LocalQwenBridge_processUserPrompt(
        JNIEnv *env,
        jobject /*unused*/,
    ...
    // Update position using the number of tokens that were actually decoded after any
    // truncation, so response generation never starts beyond the active context.
...
extern "C"
JNIEXPORT jstring JNICALL
Java_com_companyname_AndroidApp1_LocalQwenBridge_generateNextToken(
        JNIEnv *env,
        jobject /*unused*/
) {
    if (g_context == nullptr || g_model == nullptr || g_sampler == nullptr) {
...
extern "C"
JNIEXPORT void JNICALL
Java_com_companyname_AndroidApp1_LocalQwenBridge_unload(JNIEnv * /*unused*/, jobject /*unused*/) {
    // Reset long-term & short-term states
    reset_long_term_states();
    reset_short_term_states();
...
extern "C"
JNIEXPORT void JNICALL
Java_com_companyname_AndroidApp1_LocalQwenBridge_shutdown(JNIEnv *, jobject /*unused*/) {
    release_model_resources();
    if (g_backend_initialized) {
        llama_backend_free();
