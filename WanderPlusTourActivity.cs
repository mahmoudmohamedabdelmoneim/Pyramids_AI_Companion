...
{
    [Activity(Label = "@string/wander_plus_tour_title")]
    public class WanderPlusTourActivity : Activity
    {
        protected override void OnCreate(Bundle? savedInstanceState)
        {
            base.OnCreate(savedInstanceState);
            SetContentView(Resource.Layout.activity_wander_plus_tour);
            ...
            cartButton.Click += (_, _) =>
                CartActions.AddAndOpenCart(this,
                    new CartSelection("Wander Plus Tour ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â Foreigners (USD 90)", "Gate 6", foreignersTickets),
                    new CartSelection("Wander Plus Tour ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â Egyptians (USD 70)", "Gate 6", egyptiansTickets));
